    ...
    <div className="flex h-screen flex-col overflow-hidden bg-background text-foreground">
      ...
      <header className="flex h-14 shrink-0 items-center justify-between border-b border-border bg-panel px-4">
        ...
        <div className="flex items-center gap-2">
          ...
          <HeaderAuth />
          <a
            href="https://wa.me/923195066209"
            target="_blank"
            rel="noopener noreferrer"
            className="flex items-center gap-1.5 rounded-md border border-green-500/40 bg-green-500/10 px-2.5 py-1.5 text-xs font-medium text-green-400 transition-colors hover:bg-green-500/20"
          >
            ...
            <span className="hidden sm:inline">+92 319 5066209</span>
          </a>
        </div>
      </header>
